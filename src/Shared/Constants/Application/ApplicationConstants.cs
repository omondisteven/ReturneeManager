namespace ReturneeManager.Shared.Constants.Application
{
    public static class ApplicationConstants
    {
        ...
        public static class Cache
        {
            ...
            public const string GetAllIdTypesCacheKey = "all-id-types";
            public const string GetAllGendersCacheKey = "all-genders";
            public const string GetAllDistrictsCacheKey = "all-districts";
            public const string GetAllDivisionsCacheKey = "all-divisions";
            public const string GetAllUpazilasCacheKey = "all-upazilas";
            public const string GetAllFromCountriesCacheKey = "all-from-countries";
            public const string GetAllWardsCacheKey = "all-wards";
