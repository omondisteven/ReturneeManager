            ...
            if (id != 0)
            {
                ...
                if (product != null)
                {
                    parameters.Add(nameof(AddEditProductModal.AddEditProductModel), new AddEditProductCommand
                    {
                        ...
                        IdTypeId = product.IdTypeId,
                        IdNumber = product.IdNumber,
                        GenderId = product.GenderId,
                        DistrictId = product.DistrictId,
                        DivisionId = product.DivisionId,
                        FromCountryId = product.FromCountryId,
                        UpazilaId = product.UpazilaId,
                        WardId = product.UpazilaId,
                        Barcode = product.Barcode,
                        DateOfBirth = product.DateOfBirth,
                        HouseVillage = product.HouseVillage,
                        ...
                        MotherName = product.MotherName,
                        ReturnReason = product.ReturnReason,
                        ReturnDate = product.ReturnDate,
                        ReturnDocument = product.ReturnDocument,
                    });
                }
            }
