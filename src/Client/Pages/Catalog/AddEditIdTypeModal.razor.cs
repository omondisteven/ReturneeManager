...
{
    public partial class AddEditIdTypeModal
    {
        [Inject] private IIdTypeManager IdTypeManager { get; set; }

        [Parameter] public AddEditIdTypeCommand AddEditIdTypeModel { get; set; } = new();
        ...
        {
            var response = await IdTypeManager.SaveAsync(AddEditIdTypeModel);
