...
using ReturneeManager.Client.Infrastructure.Managers.Communication;
using ReturneeManager.Shared.Constants.Storage;

namespace ReturneeManager.Client.Pages.Communication
{
