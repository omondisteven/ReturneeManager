...
using ReturneeManager.Application.Features.ExtendedAttributes.Commands.Delete;
...
namespace ReturneeManager.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
